...
public class LockWithTransactionAspect extends AbstractBaseAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (keyEvaluate == null) {
            io.github.snower.jaslock.spring.boot.annotations.LockWithTransaction lockAnnotation =
                    methodSignature.getMethod().getAnnotation(io.github.snower.jaslock.spring.boot.annotations.LockWithTransaction.class);
    ...
    public Object execute(ProceedingJoinPoint joinPoint, AbstractBaseAspect.KeyEvaluate keyEvaluate, String key) throws Throwable {
