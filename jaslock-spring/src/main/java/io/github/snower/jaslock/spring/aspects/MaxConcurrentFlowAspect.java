...
public class MaxConcurrentFlowAspect extends AbstractBaseAspect {
    ...
    @Pointcut("@annotation(io.github.snower.jaslock.spring.annotations.MaxConcurrentFlow)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        io.github.snower.jaslock.spring.annotations.MaxConcurrentFlow maxConcurrentFlowAnnotation = methodSignature.getMethod()
                .getAnnotation(io.github.snower.jaslock.spring.annotations.MaxConcurrentFlow.class);
